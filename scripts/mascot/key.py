...
# These sheets have darker green antialiased outlines than the upstream samples.
# A wider key transition removes that spill; enclosed shirt details stay protected.
TOL_LOW = 40.0
TOL_HIGH = 120.0
