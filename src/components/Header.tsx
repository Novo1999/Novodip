    ...
    <>
      <motion.nav
        ...
        className={`fixed top-0 left-0 right-0 z-40 transition-all duration-300 ${
          scrolled || mobileOpen ? 'glass-card border-b border-border' : ''
        }`}
      >
        <div className="container mx-auto flex items-center justify-between h-16 px-6">
          ...
          <a
            href="#contact"
            className="hidden md:inline-flex items-center px-4 py-2 rounded-lg text-sm font-medium bg-primary text-primary-foreground hover:opacity-90 transition-opacity"
          >
            Get in Touch
          </a>
